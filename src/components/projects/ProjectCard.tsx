...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <div
      ...
      onClick={() => router.push(project.projectDetailsPageSlug)}
      role="link"
      tabIndex={0}
      onKeyDown={(e) => {
    ...
    >
      <Card className="h-full w-full overflow-hidden border-gray-100 p-0 shadow-none transition-all hover:shadow-sm dark:border-gray-800">
        ...
        <CardContent className="px-6">
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between gap-4">
              <h3 className="text-xl leading-tight font-semibold group-hover:text-primary">
                {project.title}
              </h3>
              <div
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {project.technologies.map((technology, index) => (
                  <Tooltip key={index}>
                    <TooltipTrigger>
                      <div className="size-6 transition-all duration-300 hover:scale-120">
                        {technology.icon}
                      </div>
                    </TooltipTrigger>
                    <TooltipContent>
